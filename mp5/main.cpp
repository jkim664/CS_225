...
int main() {
   ...
   //cout << "fullTree.idealPrune(100, 0,1) = " << fullTree.idealPrune(100,0,1) << endl;
   //cout << "fullTree.idealPrune(100, 195073,195075) = " << fullTree.idealPrune(100,195073,195075) << endl;
