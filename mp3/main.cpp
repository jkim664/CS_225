...
void testReverse()
{
	List<int> ilist;				//I added this
	
	cout << "[testReverse]: " << ilist << endl;
	
	for (int i = 1; i <= 10; i++) { 		// this too
		ilist.insertBack(i);
	}
	
	cout << "[testReverse]: " << ilist << endl; // and this
...
void testReverseNth()
{
	cout << "[testReverseNth]: " << endl;
	List<int> ilist;		//I added this
	
	
	
	
	for (int i = 1; i <= 6; i++) {  //this too
		ilist.insertBack(i);
	}
	cout << "[testReverseNth]: " << ilist << endl;
	ilist.reverseNth(10);
	...
	cout << "[testReverseNth]: " << ilist << endl; // also this
...
void testMerge()
{
	...
	for (int i = 1; i < 12; i+=2) {
		...
		first_list.insertBack(i);
		second_list.insertBack(i-1);
		
	}
	
	cout << "[testMerge]: " << first_list << endl;
	cout << "[testMerge]: " << second_list << endl;
	
	second_list.mergeWith(first_list);
